...
#### Heatmap for daily price for council area
...
Now you could see the housing price has been normalized according to the first value of each column to reflect their relative changes.
